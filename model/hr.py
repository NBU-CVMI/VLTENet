...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self,
        ...
        self.norm_layer = norm_layer
        # stem network
        # stem net:从 IMG 到 1/4 大小的 feature map，得到此尺寸的特征图后，之后的 HRNet 始终保持此尺寸的图片
    ...
    def forward(self, x):
        ...
        # print('x2', x[2].shape)
        # print('x3', x[3].shape)
        # x = torch.cat([x[0], x1, x2, x3], 1) # [4, 270, 32, 16]
        # print('x', x.shape)
        # x = self.last_layer(x)
